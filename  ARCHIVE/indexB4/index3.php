...
define("FREE_PLAYER_URL", "http://www.eikaiwa.fm/php/player.php?channel=nihongo_free");
define("PREMIUM_PLAYER_URL", "http://www.eikaiwa.fm/php/player.php?channel=nihongo_premium");
			...
			<td class="menu_container_middle">
				...
				<tr>
					<td class="eupdates_middle">
						...
						<?php } ?>
						<tr>
							<td colspan="2"><p style="margin: 0px; padding: 0px 0px 0px 2px;">eikiawa.fmのアップデートやイベント情報等を配信します！</p></td>
						</tr>
						<tr>
