		...
		<tr>
			<td class="menu_container_middle">
				...
				<div style="width: 178px; border-left: 1px solid #C6C47B; border-right: 1px solid #C6C47B; background: #fff;">
					...
					<!-- SPODs START -->
<center><table width="120" height="" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border: 0px #006699 solid; font-family:Arial, Helvetica, sans-serif; font-size:12px">
<tr><td bgcolor=#FFFFFF colspan=2 align=center><b></b> <small></small></td></tr>
<tr style=font-size:8pt><td align="center">

<!-- HM_AU_EKW_square -->
<script type='text/javascript'>
GA_googleFillSlot("HM_AU_EKW_square");
</script>
