...
<head>
	...
	<title>eikaiwa.fm 無料　英会話　ダウンロード　ラジオ　MP３</title>
	...
	<td class="main_menu">
		...
		<tr>
			<td class="menu_container_middle">
				...
				<div style="margin-top: 9px; width: 180px; height: 25px; text-align: left; background-image: url(<? print IMG_DIR; ?>menu-rc1a.gif); background-repeat: no-repeat;"><p style="margin:0px; padding: 8px 0px 0px 8px; font: bold 12px arial; color: #fff;">フリーサンプル (毎週更新中)</p></div>
				<div style="width: 178px; border-left: 1px solid #C6C47B; border-right: 1px solid #C6C47B; background: #fff;"><p style="margin:0px; padding: 4px 8px 0px 8px; font: 12px arial; text-align: center;"><a href="http://www.eikaiwa.fm/audio/free/eikaiwa.fm_FREE_穀物.mp3">穀物</a></p></div>
				...
				<div style="margin-top: 9px; width: 180px; height: 25px; text-align: left; background-image: url(<? print IMG_DIR; ?>menu-rc1a.gif); background-repeat: no-repeat;"><p style="margin:0px; padding: 8px 0px 0px 8px; font: bold 12px arial; color: #fff;">Sponsors</p></div>
