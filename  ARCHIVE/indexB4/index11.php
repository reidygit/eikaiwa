	...
	<td class="main_menu">
		...
		<tr>
			<td class="menu_container_middle">
				...
				<div style="width: 178px; border-left: 1px solid #C6C47B; border-right: 1px solid #C6C47B; background: #fff;"><p style="margin:0px; padding: 4px 8px 0px 8px; font: 12px arial; text-align: center;"><b>::</b>&nbsp;<a href="http://www.eikaiwa.fm/audio/free/<?php print rawurlencode('eikaiwa.fm_FREE_紙製品.mp3'); ?>" onMouseover="ddrivetip('右クリックし「対象をファイルに保存」でダウンロード','#F8FAB8', 310);" onMouseout="hideddrivetip();">紙製品</a>&nbsp;<b>::</b></p></div>
