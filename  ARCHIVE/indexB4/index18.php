...
spodHtml = '<a href=' + 'http://friends.eikaiwa.fm/welcome/' + ' target=_blank><img src=' + spod.photo.url + ' width=90' +' height=90 border=1 hspace=2 vspace=2' + '></a><br><b>' + spod.nickname + '</b><br><small>' + spod.quote + '</small>';
