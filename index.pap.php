	...
	<td class="main_menu">
		...
		<tr>
			<td class="menu_container_middle">
				...
				<!-- TURN THIS ON TO DISPLAY PARTY BANNER AT TOP OF COLUM 2 WEEKS BEFORE PARTY
...
<!-- SPODs START -->
<center><table width="120" height="" cellpadding="2" cellspacing="0" style="background-color: #ffffff; border: 1px #006699 solid; font-family:Arial, Helvetica, sans-serif; font-size:12px">
<tr><td bgcolor=#FFFFFF colspan=2 align=center><b>Eikaiwa.fm Friends</b><br> <small>Join Us! 無料!</small></td></tr>
<tr style=font-size:8pt><td align="center">
<SCRIPT language=javascript src="http://cache.meta4-group.com/eikaiwafm/spods.js?locale=ja_JP&count=1" type=text/JavaScript></SCRIPT>
<SCRIPT language=javascript>
for (var i = 0, n = wfSPODArray.length; i < n; i++) {
var spod = wfSPODArray[i];
spodHtml = '<a href=' + spod.link + ' target=_blank><img src=' + spod.photo.url + ' width=90' +' height=90 border=1 hspace=2 vspace=2' + '></a><br><b>' + spod.nickname + '</b><br><small>' + spod.quote + '</small>';
...
<a href="https://www.senseinavi.com/search.php?a_aid=4e8f4ae7&amp;a_bid=36e8a355" target=""><strong>SenseiNavi.com</strong><br/></a><img style="border:0" src="https://www.senseinavi.com/affiliates/scripts/imp.php?a_aid=4e8f4ae7&amp;a_bid=36e8a355" width="1" height="1" alt="" />
...
<script language="javascript" type="text/javascript" src="http://s1.phx.icastcenter.com/system/streaminfo.js"></script>
<script language="javascript" type="text/javascript" src="http://s1.phx.icastcenter.com/system/player.js"></script>
</body>
</html>
