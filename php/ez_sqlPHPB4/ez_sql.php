<?php
	...
	define("EZSQL_DB_USER", "reidgrec_5");			// <-- mysql db user
	define("EZSQL_DB_PASSWORD", "d7JKddeL");		// <-- mysql db password
	define("EZSQL_DB_NAME", "reidgrec_eikaiwa");		// <-- mysql db pname
	define("EZSQL_DB_HOST", "db71b.pair.com");	// <-- mysql server host
